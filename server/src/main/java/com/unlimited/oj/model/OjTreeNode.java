...
public class OjTreeNode implements java.io.Serializable {
    ...
    */
   @Basic(optional=true)
   @Column(name="opened", insertable=true, updatable=true)
   ...
   public int hashCode() {
      ...
      hashCode = 29 * hashCode + (new Integer(opened)).hashCode();
