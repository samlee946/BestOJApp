        ...
        if (ctx.getAuthentication() != null) {
            ...
            for (GrantedAuthority role1 : roles) {
                if (role1.getAuthority().equals(Constants.ADMIN_ROLE) ||
                        role1.getAuthority().equals(Constants.ADMIN_CONTEST_ROLE) ||
                        role1.getAuthority().equals(Constants.ADMIN_EXERCISE_ROLE) ||
                        role1.getAuthority().equals(Constants.ADMIN_EXAM_ROLE)) {
                    administrator = true;
                    break;
                }
            }
