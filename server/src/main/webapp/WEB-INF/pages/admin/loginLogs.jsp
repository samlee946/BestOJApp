...
<display:table name="loginLogs" cellspacing="0" cellpadding="0" requestURI="admin/showLoginLog.html"
    ...
    <display:column property="ip" sortable="false" titleKey="examPaper.ip" autolink="true" style="width:200px;text-align:center;"/>
   ...
   <table><tr>
   		...
   		<td>
		    <div align=right><input type="button"
		        onclick="location.href='<c:url value="/admin/deleteAllLoginLog.html"/>'"
		        value="<fmt:message key="button.deleteAll"/>"/>
		    </div>
   		</td>
   		<td>
		    <div align=right><input type="button"
		        onclick="location.href='<c:url value="/admin/dumpAllLoginLog.html"/>'"
