...
<s:form name="oForm" action="saveOjTreeNode" method="post" validate="true">
   ...
   <table width=380 style="margin: 0pt -2pt"><tr>
    ...
    <table width=380 style="margin: 0pt -2pt">
    	<tr>
	   		...
	   		<td width=50%>
                     <s:select list="#{100:'Node',1: 'Catalog'}" emptyOption="false" key="ojTreeNode.type"/>
   			...
   			<td colspan=2>
			    <font color="blue">Example: experiment/experimentProblemList.html?pid=......</font>
			</td>
	   	</tr>
   	</table>
    </c:if>
...
<s:form name="oForm2" action="deleteOjTreeNode" method="post" validate="true">
    <s:hidden key="ojTreeNode.id"/>
       <table><tr>
            <td>
