...
<s:form name="signupForm" action="signup" method="post" validate="true">
   ...
   <table width=380 style="margin: 0pt -2pt"><tr>
   		...
   		<td width=50%>
    		<s:textfield key="user.pkuAccount" cssClass="text medium" required="false"/>
   		</td>
   	</tr></table>
    ...
    <s:textfield key="user.passwordHint" required="false" cssClass="text large"/>
    <s:textfield key="user.email" theme="xhtml" required="true" cssClass="text large"/>
    ...
    <table width=360 style="margin: 0pt -2pt;background-color:#E0E0E0;">
    	<tr>
	   		...
	   		<td width=50%>
   	 			<s:textfield key="user.school" required="false" cssClass="text medium"/>
	   		</td>
	   		<td width=50%>
	   		...
	   		<td width=50%>
	             <s:textfield key="user.lastName" theme="xhtml" required="false" cssClass="text medium"/>
            </td>
	   		<td width=50%>
	             <s:textfield key="user.firstName" theme="xhtml" required="false" cssClass="text medium"/>
	   		</td>
   		</tr><tr>
   			<td colspan=2>
