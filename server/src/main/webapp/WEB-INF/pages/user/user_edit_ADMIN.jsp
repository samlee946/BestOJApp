...
<s:form name="userForm" action="user_user_edit_ADMIN" method="post" validate="true">
    ...
    <li class="buttonBar right">
        <c:set var="buttons">
            ...
            <c:if test="${param.from == 'list' and not empty user.id}">
                <s:submit key="button.delete" method="user_delete_PUBLIC" onclick="return confirmDelete('user')"/>
            </c:if>
