...
copy /b .\java\tmp.txt+.\stu_num\grade14_stu_num.txt .\java\tmp.txt
.\random\bin\Debug\random.exe < .\java\tmp.txt > stu_num.txt
javac -classpath ".;.\java\libs\mysql-connector-java-5.1.41-bin.jar;" .\java\GetDataFromDB14.java
java -classpath ".;.\java\libs\mysql-connector-java-5.1.41-bin.jar;.\java\;" GetDataFromDB14
echo %pplcnt% > tmp.txt
