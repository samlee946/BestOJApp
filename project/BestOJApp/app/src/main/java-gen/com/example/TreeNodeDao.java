...
*/
public class TreeNodeDao extends AbstractDao<TreeNode, Void> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TreeNode entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(TreeNode entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(TreeNode entity) {
        return null;
    }
